...
### *Замечание.*
$f$ выпукла $\Harr$ $-f$ - вогнута. Далее будем рассматривать только выпуклые функции.
...
Значит $f$ - выпуклая $\Harr$ график функции не выше хорды.

![Untitled](sem1/notes/analysis_exam/68/Untitled.png)
...
![Untitled](sem1/notes/analysis_exam/68/Untitled%201.png)
...
$\dfrac{f(x_2)-f(x_3)}{x_2-x_3}\ge\dfrac{f(x_1)-f(x_3)}{x_1-x_3}\Rarr\dfrac{f(x_3)-f(x_2)}{x_3-x_2}\ge\dfrac{f(x_3)-f(x_1)}{x_3-x_1}$
...
$\dfrac{f(x_2)-f(x_1)}{x_1-x_2}\ge\dfrac{f(x_3)-f(x_1)}{x_1-x_3}\Rarr\dfrac{f(x_2)-f(x_1)}{x_2-x_1}\le\dfrac{f(x_3)-f(x_1)}{x_3-x_1}$

$2)\Rarr3)$: Очевидно из формулировок этих пунктов.
