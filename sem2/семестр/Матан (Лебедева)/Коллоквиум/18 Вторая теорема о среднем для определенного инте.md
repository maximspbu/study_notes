...
По Т. Б-К о промежуточном значении (можем юзать, тк см [14 билет](/sem2/семестр/Матан (Лебедева)/Коллоквиум/18 Вторая теорема о среднем для определенного инте/14 Непрерывность интеграла с переменным верхним пр))  для $\dfrac{I}{g(a)}$:  
...
### Доказательство: применяем [теорему](/sem2/семестр/Матан (Лебедева)/Коллоквиум/Конспекты/05 03 24) к $g(-x)$ (вроде очев).  
...
### Доказательство:  
Если $g\searrow$, то применяем [теорему](/sem2/семестр/Матан (Лебедева)/Коллоквиум/Конспекты/05 03 24) к $g(x)-g(b)$.  
...
Если $g\nearrow$, то [следствие 1](/sem2/семестр/Матан (Лебедева)/Коллоквиум/Конспекты/12 03 24) к $g(x)-g(a)$ (аналогично).  
