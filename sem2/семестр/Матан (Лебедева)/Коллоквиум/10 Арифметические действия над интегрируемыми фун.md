...
### Доказательство:  
$1)$ Для $fg$.  
$f,g\in\mathcal{R}[a;b]\Rightarrow f,g$  [ограничены.]({{ site.baseurl }}/sem2/семестр/Матан (Лебедева)/Коллоквиум/Конспекты/13 02 24)  
...
[Воспользуемся $2)$ пунктом критерия Дарбу]({{ site.baseurl }}/sem2/семестр/Матан (Лебедева)/Коллоквиум/Конспекты/13 02 24):  
