...
### Немного распишем:  
По [лемме](30 04 24/23 04 24) $F^{(m)}(0)=d^mf(x,h)$.  
...
### Доказательство:  
Используем формулу [Тейлора-Лагранжа](30 04 24/30 04 24):  
...
### Доказательство:  
По [формуле Тейлора-Пеано](30 04 24/30 04 24) до 2 порядка $o(|h|^2):$  
