...
[Дальше воспользуемся признаком сравнения интегралов](/sem2/семестр/Матан (Лебедева)/Конспекты/19 03 24/12 03 24).  
...
[По 2 следствию 2-ой теореме о среднем](/sem2/семестр/Матан (Лебедева)/Конспекты/19 03 24/05 03 24): $\exists b_1\lessgtr c\lessgtr b_2$  
...
Отсюда по [признаку сравнения](/sem2/семестр/Матан (Лебедева)/Конспекты/19 03 24/12 03 24):$\displaystyle\int_1^{+\infty}|g(x)\sin(x)|dx$ сходится,  
...
Применим [признак Дирихле](/sem2/семестр/Матан (Лебедева)/Конспекты/19 03 24/19 03 24).  
...
$\displaystyle\int_1^{+\infty}\dfrac{g(x)\cos(2x)}{2}=\dfrac{1}{4}\int_2^{+\infty}g\Big(\dfrac{t}{2}\Big)\cos(t)dt$ сходится по [признаку Д](/sem2/семестр/Матан (Лебедева)/Конспекты/19 03 24/19 03 24).  
