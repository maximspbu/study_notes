...
Доказательство:  
$K~-~$компактно в $X$, $\\{V_\alpha\, \alpha\in A\\}~-~$покрытое $K$ множествами, открытыми в $Y$, тогда [по лемме об открытости и замкнутости в подпространстве](/sem2/семестр/Матан (Лебедева)/Конспекты/26 03 24/26 03 24): $V_\alpha=G_\alpha\cap Y,~G_\alpha~-~$открытое в X.  
...
Доказательство:  
Т.к. $K$ ограничено, то $\exists$ параллелепипед $[a,b]\supset K:$ т.к. $[a,b]$ компактен, $K$ замкнут, то по [2 свойству компактности](/sem2/семестр/Матан (Лебедева)/Конспекты/26 03 24/26 03 24) $K$ компактно. $\blacksquare$  
...
$I~-~$замкнутое в $I$, $I~-~$ограниченное и не компактен, т.к. $I~-~$открытое в $\mathbb{R}^1$ (применяем [теорему о достаточном условии компактности в $\mathbb{R}^d$](/sem2/семестр/Матан (Лебедева)/Конспекты/26 03 24/26 03 24)).  
