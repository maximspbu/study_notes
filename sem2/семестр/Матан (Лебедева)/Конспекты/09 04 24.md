...
### Следствие из [теоремы Вейерштрасса о непрерывном отображении](/sem2/семестр/Матан (Лебедева)/Конспекты/09 04 24/02 04 24).  
...
\end{cases}\Rightarrow\\\Rightarrow~B~-~$предельная точка множества $f(X)$. [$f(X)~-~$замкнута](/sem2/семестр/Матан (Лебедева)/Конспекты/09 04 24/26 03 24) $\Rightarrow\\\Rightarrow~B\in f(X)\Rightarrow\exists x_0\in X ~~ f(x_0)=B ~~ \scriptsize\blacksquare$  
