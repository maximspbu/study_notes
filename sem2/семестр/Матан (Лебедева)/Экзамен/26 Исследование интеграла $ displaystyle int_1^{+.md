...
Отсюда по [признаку сравнения](/sem2/семестр/Матан (Лебедева)/Экзамен/Конспекты/12 03 24):$\displaystyle\int_1^{+\infty}|g(x)\sin(x)|dx$ сходится,  
...
Применим [признак Дирихле](/sem2/семестр/Матан (Лебедева)/Экзамен/Конспекты/19 03 24).  
...
$\displaystyle\int_1^{+\infty}\dfrac{g(x)\cos(2x)}{2}=\dfrac{1}{4}\int_2^{+\infty}g\Big(\dfrac{t}{2}\Big)\cos(t)dt$ сходится по [признаку Д](/sem2/семестр/Матан (Лебедева)/Экзамен/Конспекты/19 03 24).  
