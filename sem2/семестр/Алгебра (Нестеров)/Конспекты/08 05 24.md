...
По теореме о [существовании поля разложения](08 05 24/24 04 24) $\exists$ поле $F~-~$поле разложения $x^{p^n}-x$. Заметим, что все корни $x^{p^n}-x$ [различны](08 05 24/24 04 24).  
