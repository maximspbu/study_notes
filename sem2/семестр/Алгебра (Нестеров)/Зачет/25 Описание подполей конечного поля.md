...
Тогда $K\subset F_q\Rightarrow F_{p^m}\subset F_{p^n}$ ([доказано]({{ site.baseurl }}/sem2/семестр/Алгебра (Нестеров)/Зачет/Конспекты/08 05 24), что $|K|=p^m$ и что это поле)$ ~~ \tiny\blacksquare$  
...
![Untitled]({{ site.baseurl }}/sem2/семестр/Алгебра (Нестеров)/Зачет/Конспекты/22 05 24/Untitled.png)  
...
Выпишем корни неприводимых многочленов по [теореме]({{ site.baseurl }}/sem2/семестр/Алгебра (Нестеров)/Зачет/Конспекты/22 05 24).  
