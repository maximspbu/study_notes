...
Весь алгоритм по сути сводится к применению [леммы об ОПК для расширенного алфавита](optimal_prefix_code.md).
...
![Untitled](sem2/notes/discrete/notes/optimal_prefix_code/Untitled.png)
